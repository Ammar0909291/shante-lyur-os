...
export class PrismaNotificationRepository implements INotificationRepository {
  ...
  private toDomain(raw: {
    id: string; userId: string; appointmentId: string | null; type: unknown; channel: unknown;
    status: unknown; title: string; body: string; data: unknown; sentAt: Date | null;
    deliveredAt: Date | null; readAt: Date | null; error: string | null; createdAt: Date;
  }): Notification {
  ...
  async findByUser(userId: string, options?: { status?: NotificationStatus; type?: NotificationType; page?: number; limit?: number }): Promise<{ items: Notification[]; total: number; unread: number }> {
