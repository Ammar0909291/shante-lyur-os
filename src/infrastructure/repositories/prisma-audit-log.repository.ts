...
export class PrismaAuditLogRepository implements IAuditLogRepository {
  ...
  private toDomain(raw: PrismaAuditLog): AuditLog {
  ...
  async findById(id: string): Promise<AuditLog | null> {
    ...
    return raw ? this.toDomain(raw as PrismaAuditLog) : null;
  }
  ...
  async findMany(options: {
    ...
    return { items: raws.map(r => this.toDomain(r as PrismaAuditLog)), total };
  }
  ...
  async create(log: AuditLog): Promise<AuditLog> {
    ...
    return this.toDomain(raw as PrismaAuditLog);
  }
  ...
  async getRecentActions(userId: string, limit: number): Promise<AuditLog[]> {
    ...
    return raws.map(r => this.toDomain(r as PrismaAuditLog));
  }
}
