...
export class CreateAppointmentUseCase {
  ...
  async execute(
    ...
    const dayOfWeek   = ['SUNDAY','MONDAY','TUESDAY','WEDNESDAY','THURSDAY','FRIDAY','SATURDAY'][moscowStart.getUTCDay()] as any;
    ...
    // Update customer profile (best-effort — client may not have a profile yet)
