...
const MOCK_INVENTORY: InventoryCategory[] = [
  {
    id: 'c1',
    name: 'Массажные масла и средства',
    items: [
      { id: 'i1', name: 'Масло миндальное профессиональное', sku: 'OIL-ALM-001', category: 'c1', quantity: 12, minQuantity: 5, unit: 'фл', costPrice: 85000, supplier: 'PharmaCos' },
      { id: 'i2', name: 'Масло ароматерапевтическое (набор)', sku: 'OIL-ARO-001', category: 'c1', quantity: 8, minQuantity: 5, unit: 'набор', costPrice: 145000, supplier: 'AromaPro' },
      { id: 'i3', name: 'Масло разогревающее', sku: 'OIL-HTG-001', category: 'c1', quantity: 3, minQuantity: 5, unit: 'фл', costPrice: 120000, supplier: 'PharmaCos' },
      { id: 'i4', name: 'Камни базальтовые (комплект)', sku: 'STN-BAS-001', category: 'c1', quantity: 2, minQuantity: 3, unit: 'компл', costPrice: 420000, supplier: 'SpaEquip' },
      { id: 'i5', name: 'Соль для обёртываний', sku: 'SLT-WRP-001', category: 'c1', quantity: 0, minQuantity: 4, unit: 'кг', costPrice: 65000, supplier: 'SpaEquip' },
    ],
  },
  {
    id: 'c2',
    name: 'Косметологические препараты',
    items: [
      { id: 'i6', name: 'Гиалуроновая кислота 2%', sku: 'HA-2PCT-001', category: 'c2', quantity: 18, minQuantity: 10, unit: 'амп', costPrice: 380000, supplier: 'MedEsthetic' },
      { id: 'i7', name: 'Пилинг-гель AHA/BHA', sku: 'PEE-AHA-001', category: 'c2', quantity: 6, minQuantity: 5, unit: 'шт', costPrice: 285000, supplier: 'MedEsthetic' },
      { id: 'i8', name: 'Мезотерапевтический коктейль', sku: 'SER-MES-001', category: 'c2', quantity: 0, minQuantity: 5, unit: 'амп', costPrice: 620000, supplier: 'MedEsthetic' },
      { id: 'i9', name: 'Крем питательный (набор)', sku: 'CRM-NRT-001', category: 'c2', quantity: 9, minQuantity: 6, unit: 'шт', costPrice: 220000, supplier: 'DermaPro' },
      { id: 'i10', name: 'Сыворотка антивозрастная', sku: 'SER-AV-001', category: 'c2', quantity: 2, minQuantity: 5, unit: 'шт', costPrice: 480000, supplier: 'MedEsthetic' },
    ],
  },
  {
    id: 'c3',
    name: 'СПА-уход и обёртывания',
    items: [
      { id: 'i11', name: 'Водоросли для обёртывания', sku: 'WRP-ALG-001', category: 'c3', quantity: 4, minQuantity: 8, unit: 'кг', costPrice: 185000, supplier: 'SpaEquip' },
      { id: 'i12', name: 'Глина для обёртывания', sku: 'WRP-CLY-001', category: 'c3', quantity: 12, minQuantity: 5, unit: 'кг', costPrice: 95000, supplier: 'SpaEquip' },
      { id: 'i13', name: 'Скраб кофейный', sku: 'SCR-COF-001', category: 'c3', quantity: 7, minQuantity: 5, unit: 'шт', costPrice: 75000, supplier: 'SpaEquip' },
    ],
  },
  {
    id: 'c4',
    name: 'Расходники',
    items: [
      { id: 'i14', name: 'Простыни одноразовые', sku: 'BED-DIS-001', category: 'c4', quantity: 300, minQuantity: 100, unit: 'шт', costPrice: 4500 },
      { id: 'i15', name: 'Полотенца одноразовые', sku: 'TWL-DIS-001', category: 'c4', quantity: 500, minQuantity: 100, unit: 'шт', costPrice: 2500 },
      { id: 'i16', name: 'Перчатки (S)', sku: 'GLV-S-001', category: 'c4', quantity: 80, minQuantity: 50, unit: 'пар', costPrice: 4500 },
      { id: 'i17', name: 'Перчатки (M)', sku: 'GLV-M-001', category: 'c4', quantity: 35, minQuantity: 50, unit: 'пар', costPrice: 4500 },
      { id: 'i18', name: 'Шапочки', sku: 'CAP-001', category: 'c4', quantity: 150, minQuantity: 50, unit: 'шт', costPrice: 1500 },
    ],
  },
];
