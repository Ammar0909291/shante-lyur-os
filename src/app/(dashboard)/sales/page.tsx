...
const MOCK_PAYMENTS: Payment[] = [
  ...
  },
  {
    ...
    appointment: {
      ...
      service: { name: 'Гиалуроновый лифтинг' },
  ...
  },
  {
    ...
    appointment: {
      ...
      service: { name: 'Химический пилинг' },
  ...
  },
  {
    ...
    appointment: {
      ...
      service: { name: 'Горячий камень (стоун)' },
  ...
  },
  {
    ...
    appointment: {
      ...
      service: { name: 'Антицеллюлитный массаж' },
  ...
  },
  {
    ...
    appointment: {
      ...
      service: { name: 'Ароматерапевтический массаж' },
      specialist: { user: { name: 'Наталья Владимирова' } },
    },
  },
];
