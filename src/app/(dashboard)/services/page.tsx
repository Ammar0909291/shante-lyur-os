...
const MOCK_SERVICES: ServiceCategory[] = [
  {
    ...
    name: 'Массаж',
    services: [
      { id: 'sv1', name: 'Классический расслабляющий', description: 'Классический расслабляющий массаж всего тела', durationMinutes: 60, price: 450000, isActive: true },
      { id: 'sv2', name: 'Тайский массаж', description: 'Традиционный тайский массаж с элементами стретчинга', durationMinutes: 90, price: 750000, isActive: true },
      { id: 'sv3', name: 'Спортивный массаж', description: 'Восстановительный массаж для спортсменов', durationMinutes: 60, price: 550000, isActive: true },
      { id: 'sv4', name: 'Глубокотканный массаж', description: 'Проработка глубоких мышечных слоёв и фасций', durationMinutes: 90, price: 850000, isActive: true },
      { id: 'sv5', name: 'Ароматерапевтический', description: 'Расслабляющий массаж с эфирными маслами', durationMinutes: 60, price: 600000, isActive: true },
      { id: 'sv6', name: 'Горячий камень (стоун)', description: 'Стоун-терапия с базальтовыми камнями', durationMinutes: 90, price: 950000, isActive: true },
      { id: 'sv7', name: 'Антицеллюлитный', description: 'Интенсивный массаж для коррекции фигуры', durationMinutes: 45, price: 400000, isActive: true },
      { id: 'sv8', name: 'Лимфодренажный', description: 'Мягкий дренирующий массаж для улучшения лимфотока', durationMinutes: 60, price: 650000, isActive: true },
      { id: 'sv9', name: 'Нейромышечный', description: 'Работа с триггерными точками и хроническими болями', durationMinutes: 75, price: 700000, isActive: true },
      { id: 'sv10', name: 'СПА-массаж (4 руки)', description: 'Синхронный массаж в исполнении двух мастеров', durationMinutes: 60, price: 1200000, isActive: false },
    ],
  },
  {
    id: 'cat2',
    name: 'Косметология',
    services: [
      { id: 'sv11', name: 'Гиалуроновый лифтинг', description: 'Инъекционное введение гиалуроновой кислоты для лифтинга', durationMinutes: 90, price: 1200000, isActive: true },
      { id: 'sv12', name: 'Биоревитализация', description: 'Глубокое увлажнение и биостимуляция кожи', durationMinutes: 60, price: 1800000, isActive: true },
      { id: 'sv13', name: 'Мезотерапия', description: 'Микроинъекции коктейлей для питания и омоложения', durationMinutes: 45, price: 1500000, isActive: true },
      { id: 'sv14', name: 'Химический пилинг', description: 'AHA/BHA пилинг для обновления кожи', durationMinutes: 45, price: 800000, isActive: true },
      { id: 'sv15', name: 'Аппаратная чистка лица', description: 'Ультразвуковая и вакуумная чистка пор', durationMinutes: 75, price: 650000, isActive: true },
      { id: 'sv16', name: 'Антивозрастной уход', description: 'Комплексная программа против возрастных изменений', durationMinutes: 90, price: 1150000, isActive: true },
      { id: 'sv17', name: 'RF-лифтинг', description: 'Радиочастотное подтяжение кожи лица и тела', durationMinutes: 60, price: 1000000, isActive: true },
      { id: 'sv18', name: 'Лазерная эпиляция', description: 'Удаление нежелательных волос лазером', durationMinutes: 60, price: 1500000, isActive: true },
      { id: 'sv19', name: 'Детокс-программа', description: 'Комплексное детоксирование кожи лица и тела', durationMinutes: 60, price: 700000, isActive: true },
      { id: 'sv20', name: 'Глубокое увлажнение', description: 'Интенсивное увлажняющее лечение для сухой кожи', durationMinutes: 60, price: 550000, isActive: false },
    ],
  },
];
